...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 15, 2018 at 09:55 AM
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `event name` (`event name`),
...
CREATE TABLE IF NOT EXISTS `events_event` (
  ...
  `prize` text,
  PRIMARY KEY (`id`),
  KEY `events_event_school_id_dc9debbd_fk_common_school_id` (`school_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `participants_participant_events`;
CREATE TABLE IF NOT EXISTS `participants_participant_events` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `participant_id` int(11) NOT NULL,
  `event_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `participants_participant_participant_id_event_id_9ebc6399_uniq` (`participant_id`,`event_id`),
  KEY `participants_partici_event_id_743cb807_fk_events_ev` (`event_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
--
