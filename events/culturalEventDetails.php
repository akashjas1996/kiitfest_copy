<script>
    var eventNames = {
            "901": "Frozen In Time",
            "902": "Mismatch - The Masterchef Event",
            "903": "Open Sesame",
            "904": "Zara Nachke Dikha",
            "905": "Tell A Tale",
            "906": "Shabd",
            "907": "Spotlight",
            "908": "Isle To Glory",
            "909": "Instant-o-fie",
            "910": "FUEGO",
            "911": "CHITRA-VI-CHITRA-CHITRAM",
            "912": "Alankaar",
            "913": "Dekh Tamasha Dekh",
            "914": "Melange",
            "915": "Tulika",
            "916": "Illustory",
            "917":"International Talent Hunt",
    }

    var eventDetails = {
        "901": `<h1>Frozen In Time</h1>
        <p>A pencil, a brush & a few colors or sometimes may be just one of these is enough to create a piece of art that can make people stop and wonder. Our aim this time, is to stop and not just wonder but   create such pieces that make people marvel. Such masterpieces, that they reflect on themselves as well as their lifestyle and their dear ones. Something which can bring about a change and can make a positive impact on people and their surroundings (socially). An art, which can give a new outlook towards living thus creating a constructive effect in our time. And this is decided as the theme of our event.</p>
			...
			<ul>
			<li>Interpretation and the clarity of the theme(a social issue that needs to be looked into  which has been neglected till now,eg:section 377 or section 497 which has been newly formed) to the viewer.</li>
			...
			<li>Overall impression of art.</li>
			</ul>
			</p>
			...
			<ol>
			<li>Angana Majumder        (Ph. No.-7873877305)</li>
			<li>Pratik Sahoo                 (Ph. No.-9938868613)</li>
			</ol>
			</p>

        `,

        "902": `<h1>Mismatch - The Masterchef Event</h1>
        <p>Did you ever wonder why Vasco Da Gama ended up discovering India? What was so special about a rarely known piece of land that the world went bonkers on finding it?
		<b>Spices aka Masala.</b>
		Yes, Masala does add taste to anything you eat and tickles your sensation in its own way. We want to discover the Masterchef inside you and participate in this event to have some fun and play with food with some creative and innovative cuisines of your choice.So, take out the cutlery, strap on the apron, pack all of them ingredients and a pinch of your secret! Light the burner, smoke the chimney, stir the pan and taste that gravy. And don't you worry, even your Maggi is better than many a curries! Ladies and gentlemen, MISMATCH is on! The kitchen is set and the flames are on. Why are you hiding now?</p>
			...
			<p><b>JUDGEMENT CRITERIA:</b>
			<ul>
			<li>Top 10 teams will be selected from 1st Round according to their knowledge regarding food.</li>
			...
			<li>2nd Round - Live Cooking will be judged by 3 Professional Chefs of 3/5 star Hotels of Bhubaneswar.</li>
			 <li>Preparation Method, Knowledge, Creativity, Taste & Quality</li>
			<li>Judges decision will be final.</li>
			</ul></p>

			<p><b>PRIZE MONEY: Rs. 30,000/-</p>

			<p><b>CONTACT DETAILS: </b>
			<ol>
			<li>Braja Kishore Mishra 9438888388</li>
        ...
        `,
        "903": `<h1>Open Sesame</h1>
        <p>Open Sesame is our take on combining writing skills and oration, emoting with words and expressing with your voice in a unique poetry slam.</p>
		<p>It is a 2 round event with participants performing their own original poetry, showcasing their writing and curating auras out in the open.</p>

			<p><b>Rules and Regulations:</b>
			<ul>
			<li>Each participant would have to submit both their poems for plagiarism check before a pre-decided date. Submit both the poems on the given email id- opensesamekf@gmail.com</li>
			...
			<p><b>Judgement Criteria:</b>
			External judges would be there to judge the participants as per pre-decided criterias.<p>

			<p><b>Prize Money:</b>
			<ol>
			<li>Winner- Rs 6000/-</li>
			<li>Runner Up- Rs 4000/-</li>
			<li>Second Runner Up- Rs 3000/-</li>
			</ol>
			</p>

			<p><b>Contact Details:</b>
			<ol>
			<li>Arka Saha- 7044067788</li>
			<li>Sharmistha Mohanty- 7504874066</li>
			<li>Sonali Ankita Mohapatra- 9930696042</li>
			</p>

        `,
        "904": `<h1>Zara Nachke Dikha</h1>
			...
			A valid College/ School ID card is required at the time of Registration. 
			Multiple teams/participants per college are allowed.
			Cross-college participation is allowed.
			Props and Costumes have to be brought by the teams themselves. 
			The loss of or damage to props is not the responsibility of the organizers.
			Pre-recorded music should be brought in a PEN DRIVE in *.mp3 format only (Any other formats shall not be entertained) Teams/Participants must follow the time limit; failing to do so shall lead to disqualification.
			In the event, if a routine is interrupted because of failure of equipment, facilities, etc., then the participant(s) affected will be permitted to restart the routine from the beginning.
			Any kind of fluid, flame, vehicle or live animals is not allowed on stage.
			Obscenity of any kind is not allowed and will lead to immediate disqualification.
			The decision of the concerned Judges and Faculty Coordinators shall be final and binding.
			Live Music is not allowed.

			</p>
			 
			<p><b>RULES FOR GROUP:</b>
			 <ul>
			...
			<p><b>JUDGING CRITERIA FOR GROUP:</b>
			 
			Choreography, Co-ordination, Creativity, and originality will be given more weightage, Prop utilization (if any), Stage Utilization, Theme relevance.</p>
			 
			<p><b>PRIZE DISTRIBUTION FOR GROUP:</b>
			 
			1st prize- 20,000 INR  2nd prize- 10,000 INR</p>
			 
			<p><b>RULES FOR SOLO:</b>
			 
			<p>First Round:
			 
			Online video submission. The last date is 14th February. Participants should send their videos to soloentries2018@gmail.com 
			Time limit - 2 min (maximum)
			Genre - Any Dance Form</p>
			...
			<p><b>JUDGING CRITERIA FOR SOLO:</b>
			 
			Facial expression and Body Language, Choreography Creativity and Presentation, Overall clarity and impact, Prop utilization(If any), Versatility and Beat sense.</p>
			 
			<p><b>PRIZE DISTRIBUTION FOR SOLO:</b>
			 
			1st Prize:– 2000 INR, 2nd Prize:–1000</p>
			 
			 
			<p><b>RULES FOR DUET</b>
			 
			<p>First Round:
			Genre-Any Dance Form 
			Time limit- 2 min (maximum)</p>
			 
			<p>Final Round:
			Time Limit- 3+1 min
			Prop needed- Any piece of cloth (elastic strip, dupatta, cotton cloth etc.)</p></p>
			 
			<p><b>JUDGING CRITERIA FOR DUET:</b>
			 
			Facial expression and Body Language, Choreography Creativity and Presentation, Overall clarity and impact, Prop Utilization(must), Versatility and Beat sense.</p>
			 
			<p><b>PRIZE DISTRIBUTION FOR DUET:</b>
			 
			1st Prize – 4000 INR, 2nd Prize-3000</p>
        ...
        `,
        "905": `<h1>Tell A Tale</h1>
        <p><b>Description:</b>
		This event is an online flash fiction competition hosted, in collaboration with The Poets Weed (TPW).
		Participants would be required to frame a micro tale based on a given theme and shall be judged on the basis of creativity and skill. It is one round event and all entries shall be accepted online only.</p>
		...
		<p><b>Judgement Criteria:</b>
		Judges from the TPW organization would judge the entries and the three best entries would be uploaded to the TPW page.</p>

		<p><b>Prize Money:</b>
		None. The top three would be featured on the “The Poets Weed” fb page.</p>

		<p><b>Contact Number:</b>
		<ol>
		<li>Anmol Mishra: 8770627588</li>
		<li>Animesh Mishra: 8726687774</li>
		</ol>
		</p>

        `,
        "906": `<h1>Shabd</h1>
        <p><b>Description:</b> Competition of performing poetry or story or Shayari with some background music or the participants can use props in order to represent their ideas. </p>
		...
		<li>ATUL KONDLIYA - 7064001831</li>
		</ol>
		</p>
        ...
        "907": `<h1>Spotlight</h1>
        	<p><b>Description: </b>
			Let the emotions flow from page to stage!  The colourful lights, camera and the audience are waiting for you. </p>
			<p><b>Rules and judgement criteria:</b>
			<ol>
			...
			<p><b>Prize money:</b> 35,000</p>




        `,
        "908": `<h1>Isle To Glory</h1>
		...
		<p><b>Team limit:</b> 5-15
		Please bring TWO HIGH-QUALITY copies of your music in a pen drive to the competition for the pre finals.
		Tracks for the battle round will be provided by the organizing team.</p>
		 
		<p><b>Rounds:</b>
		 <ol>	
		<li>Pre-finals (Round-1): (Day-1)
		The teams have to showcase. This is an elimination round.
		Time limit: 4min+1min.
		Props are allowed.
		 </li>

		<li>Finals (Round-2): (Day-2)
		The top 4 teams of the previous round will be qualifying for this round.
		First there will be a battle round among the four teams and then there will be the final battle.
		Usage of props is not allowed. However, dancing/playing with cap or clothes is allowed.
		Substitutions may be made in the event of an injury or other serious circumstance. However, all substitutions must be pre-approved by organizers.</li>
		</ol>
		</p>
		...
		<li>Creativity</li>
		 ...
		 <p><b>Prizes Money: </b> Rs. 15,000/-</p>

		<p><b>CONTACT :</b>
		 <ol>
		 <li>ROHIT KUMAR - 07504420257 , 9852882745</li>
		 <li>AAYUSH JHA - 8455053882</li>
		 <li>ANKIT AJAY - 8877809111</li>
		 </ol></p>
        ...
        `,
        "910": `<h1>FUEGO</h1>
        <p><b>Description of the event- </b> Fuego gives you a platform to showcase the inbuilt performer and artist within you. It is a  band competition which comprises of 3 rounds which are online,pre-finals and finals.Perform your heart out and be the rockstar you've always wanted to be.</p>

		<p><b>Rules and Regulations:-</b>
		<ol>
		<li>There will be two rounds i.e. pre-finals and finals, before which the bands will have to send their entries to entries.fuego@gmail.com by 'date'.</li>
		<li>The subject line should mention “Fuego”, and include your contact details in the mail body.</li>
		<li>Entries sent should either be a YouTube link. The video can be of a live performance or that of a jam-pad.</li>
		<li>The selection of the bands for the pre-finals shall be on the basis of originality of music, overall sound of the band.</li>
		<li>Top 10 bands will be selected on the basis of the above mentioned points and will have to report to the given venue for the pre-finals, after completing their Online Registration for the fest.</li>
		<li>The lineup of the bands should not change throughout the course of the event or the band shall be disqualified. The organizing committee must be informed beforehand if there are any changes in the lineup.</li>
		</ol></p>

		<p><b>Pre-finals:-</b>
		<ol>
		<li>The bands will be given a stage time of minimum 6+4 mins(inclusive of sound check).Exceeding the time limit will result in deduction of marks.</li>
		<li>No obscenity is allowed in the lyrics or the performance of the bands. Doing so will result in disqualification..</li>
		</ol></p>

		<p><b>Finals</b>
		<ol>
		<li>The bands will be given a stage time of 30 minutes(inclusive of sound check). Exceeding the time limit will result in deduction of marks.</li>
		<li>Bands have to play a minimum of 3 songs within the given time limit, one of which must be an original.</li>
		<li>No obscenity is allowed in the lyrics or the performance of the bands. Doing so will result in disqualification.</li>
		...
		The organizing committee holds the right to change the rules any time and the bands must obey.</p>

		<p><b>Prize Money:- </b>
		<ol>
		<li>1st Prize –20000 INR</li>
		<li>2nd Prize - 10000 INR</li>
		</ol>
		</p>
		
		<p><b>Contact Details:-</b>
		<ol>
		<li>Ritam - 7209773806</li>
		<li>Anusha - 9776942903</li>
		</ol>
		</p>
        ...
        "911": `<h1>CHITRA-VI-CHITRA-CHITRAM</h1>
		...
		SUBMISSION DEADLINE WILL BE PROVIDED TO SHOOT AND EDIT THE FILM.</li>
		<li>DURATION-15 minutes+2 minutes (grace time) INCLUDING END CREDITS.</li>
		</ol>
		</p>


		<p><b>CATEGORY-C:-</b> CHITRAM
		The short film story should be weaved around KIITFEST 5.0.
		THEME-KIITFEST 5.0
		...
		<li>The Participants of the CATEGORY-A:-CHITRA. NEED TO REGISTER WITH A SINGLE REGISTRATION PER TEAM FOR ALL NON-KIIT PARTICIPANTS AND ENTIRE TEAM REGISTRATION FOR KIIT  STUDENTS.
		<li>THE NON KIIT REGISTRATIONS IN CATEGORY-A:-CHITRA SUBMISSIONS OF
		              SINGLE REGISTRATION PER TEAM,WILL NOT BE ELIGIBLE TO TAKE PART IN ANY              OTHER EVENT.
		 <li>THE PARTICIPANTS OF CATEGORY B:-VI-CHITRA & CATEGORY C-CHITRA
		<li>ENTIRE TEAM SHOULD BE REGISTERED TO BE ELIGIBLE TO SUBMIT THE ENTRY.i.e-KIIT OR NON KIIT PARTICIPANTS.
		...
		<li>ONCE SUBMITTED, THE ORGANISERS HOLD THE RIGHTS TO USE THE VIDEO
		<li>FOR PROMOTIONAL PURPOSES OF THE EVENT IF ANY.
		...
		<p><b>CONTACT DETAILS WITH PHONE NUMBER.</b>
		<ol>
		<li>YANNAM DEEPAK-9494961579</li>
		<li>SWAPNIL DAS-7536924931</li>
		<li>PRATIK PANDEY-9162864839</li>
		</ol>
		FURTHER DETAILS & THE FINAL SCREENING LIST AND SCHEDULE TO BE FOLLOWED UP IN THE KIIT FEST5.0 WEBSITE.</p>


        `,
        "912": `<h1>Alankaar</h1>
         <p><b>Description of the event -</b> Alankaar presents you with a platform to showcase the striving performer within you. It is a solo singing competition which comprises of two rounds which are prelims and finals. Sing to your heart's content and be the heartthrob you always wanted to be.</p>

		<p><b>Rules and Regulation -</b></p>
		
		<p><b>Prelims</b>
		<ol>
		<li>Prelims will be conducted wherein participants will be given to perform for a time limit of 2+1 minutes including setup.
		<li>Participants need to perform a single song/piece in hindi or English or both. The song or the instrumental piece can be of any genre or an original composition.
		<li>Participants can perform with one instrument accompaniment or backing track.
		</ol></p>

		<p><b>Finals</b>
		<ol>
		<li>Participants will be given a random word on spot(Hindi or English based on their preference).They are required to sing a song that must include the given word.They will be allowed to replace the given word for maximum once.
		<li>Time limit for the performance is 3+1 minutes including setup after which marks will be deducted or the participant might be disqualified as per the jury decision.
		<li> Performers will be disqualified on spot for misconduct, obscenity or foul language.
		<li>Participants can perform with one instrument accompaniment.
		</ol>
		</p>
		...
		<p><b>Contact Details-</b>
		<ol>
		<li>Anusha Tripathi- 9776942903</li>
		<li>Ritam Dutta- 7209773806</li>
		</ol></p>


        `,
        "913": `<h1>Dekh Tamasha Dekh</h1>
		...
		<li>Production (Efficient use of space, Relevance of the musical soundtrack and Props)</li>
		</ul>
		...
		<li> Theme- Met Gala
		<li>Attraction- Usage of recyclable materials such as used bottles, plastic, cardboard to keep it less expensive.
		</ol>
		</p>
		<p><b>Rules and Regulations:</b>
		</p>

		<p><b>Prelims:</b>  Total number of registered teams</p>
		<p><b>Finals:</b>  2/3rd of the total number of teams will be selected based on judges’ unanimous decision.
		
		 <ol>
		<li>12 performing members (maximum) in each team.
		...
		<li>Black out of lights in between the performance is not allowed.
		</ol>
		</p>

		<p><b>Time limit: </b>
		<ul>
		<li>Prelims: 6-7 minutes 
		<li>Finals: 11-12 minutes
		</ul>
		</p>


		<p>Overruling any of the above mentioned will lead to penalty in marks/disqualification.</p>

		<p><b>Judgement Criteria: </b>
		<ol>
		<li> Stage discipline- 20 marks                    
		<li>Theme Relevance- 20 marks               
		<li>Coordination & formation- 20 marks                    
		<li>Props- 20 marks                    
		<li>Individual walk- 20 marks(stage presence)
		</ol></p>
		 
		<p><b>Prize Money: </b>
		<ol>
		<li>Winners - Rs. 25,000/-
		<li>Runners up - Rs. 10,000/ 
		</ol>
		</p>

		<p><b>COORDINATORS:</b>
		<ol>
		<li>Rishabh Soni - 8658404058
		<li>Swayenshu Mohanty - 9438589623                                       
		<li>Shresth Vashisth - 9199368122
		</ol>
		</p>
...
`,
		...
		Creativity (10), 
		Construction(10), 
		Relevance with topic and use of allotted word (10)
		Painting: 
		Creativity (10), 
		Relevance to story (10)
		</p>
		...
		<p><b>PRIZE MONEY:</b>
		<ol>
		<li>1st prize: ₹12000</li>
		<li>2nd prize: ₹8000</li>
		</ol>
		</p>

		<p><b>CONTACT:</b>
		<ol>
		<li>Swagatika (7873632732) </li>
		<li>Anuttama (90733 60613) </li>
		</ol></p>

        `,
        "917":`

		<h1>International Talent Hunt</h1>
		...
		<ul>
		<li> The participants will choose their topic and bring their own material to work on the making of the costumes for the event. For this they will be allotted 1-hour time.
		<li>The duration of the contest will be of 3 hours time, which are divided as follow....
		1hr to prepare their costume and design.
		...
		<li>Hasman Isabel Pedro, 9938135129
		<li>Jitsuen Dema Tshering, 7751013227
		<li> Lorna Akoth, 7609912253
		<li>Manavendra Raj Dwivedi, 8114331096
		</ul>
		</p>
