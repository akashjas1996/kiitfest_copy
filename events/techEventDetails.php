...
`,
        ...
        "501":`
            ...
            <p><b>Description:</b></p>
            <ol>
                <li>The participant will have to code in blank screen within a defined timeframe.</li>
                <li>Points will be credited on basis of minimum errors.</li>
                <li>If there is a tie, the participants will have to code in reverse manner. the game will have two rounds in which first round is an elimination round.</li>
            </ol>
        ...
        "503": `
            ...
            <p><b>Description:</b></p>
            <ol>
                <li>The participants will not be allowed to participate in both Phone & DSLR Photography</li>
                <li>They have to submit it by the deadline given, directly from the SD card of the camera.</li>
                <li>No editing of photograph is allowed.</li>
                <li>All kinds of camera can be used.</li>
                <li>Pen drives, SD Card, USB cables have to be carried by the participants.</li>
                <li>Laptops will be provided by the organisers.</li>
                <li>No pre-shot photos will be entertained.</li>
                <li>Date and time should be mention in the picture.</li>
            </ol>
        ...
        "504": `
            ...
            <ol>
                ...
                <li>The game will be containing various implications of IOT(Internet of things ) in the second round.</li>
            </ol>
            <p><b>Prize Money:</b> 20,000</p>
            <p><b>COORDINATOR:</b></p>
            <ul>
                <li>Ravi Kumar (+91-9905083800)</li>
                <li>Subhajit Kundu (+91-8840782451)</li>
            </ul>
        `,
        "505": `
            <h1>DataJAM</h1>
            ...
            <p><b>Description:</b> </p>
            <ol>
                <li>The first round will have the participants solving complex mathematical problems. Teams will be rewarded points based on their performance. Points will be carried over to the next round.</li>
                <li>Teams who are new to big data will be given an orientation on big data and how to approach the next round. </li>
                <li>In the second round the teams will be given data sets from different sources and will have to perform various operations on them. The operations will be specified on the spot. Points will be rewarded based on the team’s performance. The team with the highest points in the end wins.</li>
            </ol>
            <p><b>Judgement:</b> </p>
            <ul>
                <li>Round 1: Points will be awarded to teams for solving the questions correctly.</li>
                <li>Round 2: Points will be awarded based on the teams’ performance in the given tasks.</li>
            </ul>
            <p><b>Prize Money:</b> 20,000</p>
            <p><b>COORDINATOR:</b></p>
            <ul>
                <li>Suvendu Chatterjee (+91-8170995409)</li>
                <li>Swamway Roy (+91-7003478196)</li>
            </ul>
        `,
        "506": `
            <h1>Algonigma</h1>
            ...
            <p><b>Description:</b></p>
            <ol>
                <li>The first round will have the participants solving MCQs based on concepts from algorithms and cryptography. Points will be awarded based on number of correct answers. Incorrect answers will result in deduction of points.</li>
                <li>In the second round participants will be given a real life problem to solve and have to design & develop the algorithm to solve that problem. Points will be given by judges based on efficiency of the participants’ solution and the time taken. </li>
            </ol>
            <p><b>Judgement:</b></p>
            <ul>
                <li>Round 1: Top 8 teams with highest points will qualify for the next round.</li>
                <li>Round 2: Teams will be judged based on their efficiency of the algorithm and the time taken to solve the problem.</li>
            </ul>
            <p><b>Prize Money:</b> 20,000</p>
            <p><b>COORDINATOR:</b></p>
            <ul>
                <li>Shashank Mishra (91-9905660327)</li>
                <li>Shivam Shukla (+91-8115154165)</li>
            </ul>
        `,
        "507": `
            <h1>Appathon </h1>
            ...
            <p><b>Judgement: </b></p>
            <ul>
                <li>Round 1: Teams will be awarded points based on the the creativity and innovation of the idea they will present. </li>
                <li>Round 2: Points will be awarded based on the usefulness of the app and how relevant it is compared to the idea the team presented in the previous round. Finally, the apps with the most functionality and least bugs will win. </li>
            </ul>
            <p><b>Prize Money:</b> 20,000</p>
            <p><b>COORDINATOR:</b></p>
            <ul>
        ...
        "508": `
            ...
            <p><b>Description:</b></p>
            <ol>
                <li>Round 1 consists of a quiz round where all the teams will be given the same question.</li>
                <li>Round 2  will be a buzzer round the 6 teams present will go head to head in a fight to see who knows their tech the most. The team which presses the buzzer first gets to answer first. Incorrect answers will result in deduction of points.</li>
            </ol>
            <p><b>Judgement:</b></p>
            <ul>
                <li>Round 1: Top 6 teams with highest points will qualify for the next round.</li>
                <li>Round 2: Teams awarded points for correct answers and deducted points for wrong answers. Team with highest points wins.</li>
            </ul>
            <p><b>Prize Money:</b> 20,000</p>
            <p><b>COORDINATOR:</b></p>
            <ul>
        ...
        Burj-Al-Paper is an event in which participating teams need to build free standing frame by news-papers and tape only.</p>
        ...
        <li> No two teams must have any common member.
            ...
            <p><b>Judging Criteria:</b>
            The final decision will be made on the basis of aesthetic view, height & stability of the structure.</p>

            <p><b>Faculty Coordinators:</b>
            <ul>
            <li>Dr. J.P. Padhi-9692023641
            <li>Prof. Sitam Suvam-8763378151
            <li>Prof. Neha Nasreen 8210359573
            </ul>
            </p>

            <p><b>Student Coordinators:</b>
            <ul>
            <li>Rishabh Shukla-9984816911
            <li>Trisha Bej-7873877211
            <li>Nilanjana Saha-8256928203
            </ul></p>
        `,
        "602": `<h1> CAD-NOVUS </h1>
...
A cryptic crossword is a fun event in which a team is given a jumbled crossword puzzle which they have to solve.  After solving that puzzle, team members have to convey the hidden message to the other teammate. This event aims for providing some refreshment to all participants. It involves both the physical exertion and the mental activity of developing strategies to solve and clear the various stages of the puzzle. It is an event where everyone competes equally, and age is not dominated by youth and learn about teamwork, gain self-confidence and develop leadership abilities while having fun and getting welcome stress-relief.</p>
    ...
    <p><b>JUDGING CRITERIA:</b>
    Top two teams solving the puzzle with minimum time will be awarded.</p>

    <p><b>FACULTY COORDINATOR: -</b> Prof. Gaurav Udgata (+91 9438280569)</p>

    <p><b>STUDENT COORDINATORS: - </b>Vaibhav Rathore (+91 7064443343),
         Swagato Saha (+91 7873688258)</p>
        `,
        "605": `
