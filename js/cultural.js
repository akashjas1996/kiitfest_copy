...
<h1 style="text-align:center; font-size: 5em;";>&nbsp</h1>
<svg  class="gears" x="0px" y="0px" viewBox="0 0 932.179 932.179" xml:space="preserve">
	<g>
		<path class="gear1" d="M61.2,341.538c4.9,16.8,11.7,33,20.3,48.2l-24.5,30.9c-8,10.1-7.1,24.5,1.9,33.6l42.2,42.2c9.1,9.1,23.5,9.899,33.6,1.899
		...
		<path class="gear2" d="M867.699,356.238l-31.5-26.6c-9.699-8.2-24-7.8-33.199,0.9l-17.4,16.3c-14.699-7.1-30.299-12.1-46.4-15l-4.898-24
		...
		<path class="gear3" d="M205,704.438c-12.6,1.3-22.3,11.899-22.4,24.6l-0.3,25.3c-0.2,12.7,9.2,23.5,21.8,25.101l18.6,2.399
...
eventContent.html(defaultContent);
